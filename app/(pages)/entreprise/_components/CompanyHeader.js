...
export default function CompanyHeader({ legalUnit }) {
  ...
  return (
    <div className="bg-white p-4 rounded-3 shadow-sm mb-4">
      {/* Alertes et informations spéciales */}
      <div className="company-alerts mb-3">
        ...
        {legalUnit.statutdiffusion && legalUnit.denominationUsuelle && (
          <div className="mb-3">
            <small className="text-muted">Dénomination usuelle: </small>
            <span className="fw-medium">{legalUnit.denominationUsuelle}</span>
          </div>
        )}
      </div>
            ...
            <Row className="g-3">
              ...
              <Col md={4}>
                <div className="detail-group">
                  ...
                  <small className="badge bg-light text-dark border mt-1">
